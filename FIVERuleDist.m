function [RD] = FIVERuleDist(U, VE, R, X)
...
%
    ...
    [n, m] = size(R); % m-1 is the dimension of the antecedent universe

    for i = 1:n% Go through all rules
        dm = FIVEVagDist(U(1:m - 1, :), VE(1:m - 1, :), R(i, 1:m - 1), X);
