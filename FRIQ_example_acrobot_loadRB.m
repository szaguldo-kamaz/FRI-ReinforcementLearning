% Acrobot Problem example - Load a previously constructed RB
...
FRIQ_init_constants();
FRIQ_example_acrobot_setup();

FRIQ_param_norandom                     = 1;
FRIQ_param_construct_rb                 = 0;
FRIQ_param_reduce_rb                    = 0;
FRIQ_param_test_previous_rb             = 1;
FRIQ_param_test_previous_rb_filename    = 'rulebases\FRIQ_example_acrobot_incrementally_constructed_RB.csv';
